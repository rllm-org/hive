              ...
              <div className="relative">
                ...
                {menuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-8 z-20 bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg shadow-lg py-1.5 min-w-[180px]">
                      <button
                        onClick={() => { setMenuOpen(false); setShowAdminDialog("invalidate"); }}
                        className={`w-full text-left px-3.5 py-2 text-sm font-medium transition-colors ${isValid ? "text-red-500 hover:bg-red-500/10" : "text-emerald-600 hover:bg-emerald-500/10"}`}
                      >
