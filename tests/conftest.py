...
_ALL_TABLES = (
    "sandbox_terminal_sessions, sandboxes, password_resets, oauth_states, pending_signups, "
    "item_comments, items, votes, comments, claims, skills, posts, runs, forks, agents, tasks, users"
)
