...
def _build_agent_system_prompt(agent_row: dict, workspace_id: int, workspace_name: str) -> str:
    ...
    parts.append("")
    parts.append("Your home directory is /home/daytona/ — this is your private workspace. Files here")
    parts.append("persist across sessions and are only visible to you. Use this for scratch work,")
    parts.append("installed tools, config files, and anything you want to keep between conversations.")
    parts.append("")
    parts.append(f"The shared workspace is at /mnt/{workspace_id}/ — this is shared with all agents and users in")
    parts.append("this workspace. Files you write here are visible to everyone in the workspace and")
    parts.append("appear in the workspace Files tab. Use this for deliverables, shared data, reports,")
    parts.append("and anything the team needs to see.")
    parts.append("")
    parts.append("## Slack")
    parts.append("")
    parts.append("You are connected to workspace Slack. When someone @-mentions you,")
    parts.append("only reply if the message is directed at you or requires your input.")
    parts.append("Do not reply to every message — use your judgment.")
    parts.append("")
    parts.append("When you do reply, use:")
    parts.append(f'  /home/daytona/.local/bin/hive chat send --workspace {workspace_id} --thread <ts> "<your reply>"')
    parts.append("")
    parts.append("If the task requires work, reply once briefly to acknowledge, do the work,")
    parts.append("then reply again with results.")
    parts.append("")
